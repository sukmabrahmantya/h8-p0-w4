...
Level kedalaman array akan di-asumsikan selalu 3, [ [ [ ] ] ], jika yang diberikan 
adalah array kosong maka kembalikan nilai 'No number'
*/
...
function deepSum(arr) {
  ...
  if (arr.length > 1) {
    for (var i = 0; i < arr.length; i++) {
      // console.log(arr[i] + "====> ini i ");
      for (var j = 0; j < arr[i].length; j++) {
        for (var k = 0; k < arr[i][j].length; k++) {
          // console.log(arr[i][j][k] + "===> ini i j k");
